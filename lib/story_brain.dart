...
class StoryBrain {
  ...
  void nextStory(int choicNumber) {
    if (_storyNumber == 3 || _storyNumber == 4 || _storyNumber == 5) {
      restart();
    } else if (choicNumber == 1 && _storyNumber == 0) {
      _storyNumber = 2;
    } else if (choicNumber == 2 && _storyNumber == 0) {
      _storyNumber = 1;
    } else if (choicNumber == 1 && _storyNumber == 2) {
      _storyNumber = 5;
    } else if (choicNumber == 2 && _storyNumber == 2) {
      _storyNumber = 4;
    } else if (choicNumber == 1 && _storyNumber == 1) {
      _storyNumber = 2;
    } else if (choicNumber == 2 && _storyNumber == 1) {
      _storyNumber = 3;
    }
...
//TODO: Step 22 - In nextStory() if the storyNumber is equal to 3 or 4 or 5, that means it's the end of the game and it should call a method called restart() that resets the storyNumber to 0. //current
